...
enum media_type_e { UNK_TYPE = 0, ISO_TYPE = 1, DSDIFF_TYPE = 2, DSF_TYPE = 3 };
...
public:
	...
	virtual sacd_media_t* get_media() = 0;
	...
	virtual void get_info(uint32_t subsong, file_info& info) = 0;
	virtual void set_info(uint32_t subsong, const file_info& info) = 0;
	...
	virtual bool set_samplerate(sacd_media_t* p_file, uint32_t p_samplerate) { return false; };
};
